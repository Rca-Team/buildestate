...
const FAQ_ITEMS = [
  ...
  {
    question: 'Can I list my property exclusively with RCA Estate?',
...
const ContactPage: React.FC = () => {
  useSEO({
    title: 'Contact Us',
    description: 'Get in touch with RCA Estate. We\'re here to help you find your dream property.',
    url: 'https://rcaestate.vercel.app/contact',
  });
